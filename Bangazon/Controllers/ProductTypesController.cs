...
namespace Bangazon.Controllers
{
    public class ProductTypesController : Controller
    {
        ...
        public async Task<IActionResult> GetProductTypeReports()
        {

            var productTypeReports = await _context.ProductType.Select(pt => new ProductTypeWithProductCountViewModel()
            {
            ...
            return View(productTypeReports);
    }
    // GET: ProductTypes
    public async Task<IActionResult> GetProductTypeForNav()
    {
        var productTypes = await _context.ProductType.ToListAsync();
        return View(productTypes);
    }
